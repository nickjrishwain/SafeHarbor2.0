...
&ensp; &ensp; &ensp; &ensp; (v)  To the extent the network allows it, this notice of reliance may be provided in the source code of the token itself as a boolean or string statement of reliance that immutably links to website or IPFS hash that provides this disclosure.  This reliance written in the Token would provide notice to all parties using the blockchain reliance is being made by the Intitial Development Team on this Safe Harbor.
